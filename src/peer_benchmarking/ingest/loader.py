...
# 14 Korean insurer peers — see data/ref/companies.csv for full mapping.
# 사용자 변경 (2026-05-13): 신한·흥국·교보·KB라이프·메리츠 추가,
# 코리안리·롯데손해 제외. 메트라이프·라이나는 DART 미제출.
INSURER_CIKS = (
    "00112332",  # 미래에셋생명 (self) — IFRS17 풍부
    "00126256",  # 삼성생명 — IFRS17 풍부
    "00113058",  # 한화생명 — IFRS17 풍부
    "00117267",  # 동양생명 — IFRS17 풍부
    "00112882",  # 교보생명 — BS only (비상장)
    "00137517",  # 신한라이프 — BS only
    "00167068",  # 흥국생명 — BS only
    "00160393",  # KB라이프 — 보험계약부채 element 없음, 부채/자산만
    "00139214",  # 삼성화재 — IFRS17 풍부
    "00164973",  # 현대해상 — IFRS17 풍부
    "00159102",  # DB손해보험 — IFRS17 풍부
    "00135917",  # 한화손해보험 — IFRS17 풍부
    "00103176",  # 흥국화재 — IFRS17 풍부
    "00117744",  # 메리츠화재 — BS only
)
